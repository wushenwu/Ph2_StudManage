...
ALL : "..\bin\Client.exe" "$(OUTDIR)\Server.pch" "$(OUTDIR)\Server.bsc"
...
CLEAN :
	...
	-@erase "..\bin\Client.exe"
	-@erase "..\bin\Client.ilk"
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Client.pdb" /debug /machine:I386 /out:"../bin/Client.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\HelpDlg.obj" \
	"$(INTDIR)\InfoEdit.obj" \
	"$(INTDIR)\LogView.obj" \
...
"..\bin\Client.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
"$(INTDIR)\HelpDlg.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Server.pch"
...
"$(INTDIR)\InfoEdit.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Server.pch"


!ELSEIF  "$(CFG)" == "Server - Win32 Debug"


"$(INTDIR)\InfoEdit.obj"	"$(INTDIR)\InfoEdit.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Request.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Server.pch"
