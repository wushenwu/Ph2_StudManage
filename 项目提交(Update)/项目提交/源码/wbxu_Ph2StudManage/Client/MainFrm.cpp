...
void CMainFrame::SetConnected()
{
    m_nMenuID = IDM_START;   
}

/************************************************************************/
/* 在分割的TreeView视图中，显示表名信息，供用户选择                                                                     */
/************************************************************************/
void CMainFrame::SetTblNames(const char *pszTblNames, CNetWork *pNet)
{ 
    gs_pTblTreeView->LoadTblTree(pszTblNames, pNet);
}

/************************************************************************/
/* 在分割的ListView视图中，显示查询所得结果                                                                     */
/************************************************************************/
void CMainFrame::SetSelResults(const char *pszRet)
{
    gs_pTblInfoView->SetSelResults(pszRet);
}

void CMainFrame::SetUpdateTime(const char *pszUpdateTime)
{
    gs_pTblInfoView->SetUpdateTime(pszUpdateTime);
}
