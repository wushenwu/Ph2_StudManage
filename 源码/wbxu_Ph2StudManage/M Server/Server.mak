...
ALL : "..\bin\M Server.exe" "$(OUTDIR)\Server.pch" "$(OUTDIR)\Server.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\M Server.pdb"
	-@erase "$(OUTDIR)\Server.bsc"
	-@erase "..\bin\M Server.exe"
	-@erase "..\bin\M Server.ilk"
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\M Server.pdb" /debug /machine:I386 /out:"../bin/M Server.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\LogView.obj" \
	"$(INTDIR)\MainFrm.obj" \
	"$(INTDIR)\MyPacket.obj" \
...
"..\bin\M Server.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
